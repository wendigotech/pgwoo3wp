...
function pg_starter_setup() {
    ...
    */
    ...
    load_theme_textdomain( 'pgwoo3', get_template_directory() . '/languages' );
...
if ( ! function_exists( 'pg_starter_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'classie', get_template_directory_uri() . '/components/freelancer/js/classie.js' );
